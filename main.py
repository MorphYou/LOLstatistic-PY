...
# Jedyna klasa w programie do obsługi API
class RiotAPI:
    ...
    def get_match_history(self, puuid: str, count: int = 25) -> Optional[List[str]]:
        # Historia meczy
    ...
    def get_champion_mastery(self, puuid: str) -> Optional[List[Dict]]:
        # Tutaj poberamy informacje do TOP Championów
...
def get_queue_type(queue_id):
    queue_types = {
        ...
        440: "Ranked Flex",
        450: "ARAM",
        700: "Clash",                        ############ Tyle znalałem rodzai wg ddragon
        830: "Co-op vs AI",
        840: "Co-op vs AI",
        850: "Co-op vs AI",
        900: "URF",
    ...
    try:
        ...
        for match in matches_data:
            try:
                ...
                # Nazwa championa ma ograniczoną szerokość bo psuła się czytelność
...
def get_current_lol_version():
    try:
        ...
        return "14", "24"  # na początku miałem błędy więc użyłem i zostawiłem "domyślnej"
...
match_history_panel.bind("<Configure>", configure_match_scroll) # <Configure> reaguje na zmiane
